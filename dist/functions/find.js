...
export var find = function (db, collectionPath) {
    if (typeof collectionPath === "function") {
        var findFn = function (parentId, clauses, options) { return __awaiter(void 0, void 0, void 0, function () {
            var _collectionPath;
            return __generator(this, function (_a) {
                _collectionPath = collectionPath(parentId);
                return [2 /*return*/, findWithCollectionPath(db, _collectionPath, clauses, options)];
            });
        }); };
        return findFn;
    }
    else {
        var findFn = function (clauses, options) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, findWithCollectionPath(db, collectionPath, clauses, options)];
            });
        }); };
        return findFn;
    }
};
export var findWithCollectionPath = function (db, collectionPath, clauses, options) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                q = query.apply(void 0, __spreadArray([collection(db, collectionPath)], queryContstraints, false));
