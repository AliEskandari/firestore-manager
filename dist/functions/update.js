    ...
    if (typeof collectionPath === "function") {
        var updateFn = function (parentId, id, data) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, updateWithCollectionPath(db, _collectionPath, id, data)];
            });
        }); };
        return updateFn;
    }
    else {
        var updateFn = function (id, data, options) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, updateWithCollectionPath(db, collectionPath, id, data)];
            });
        }); };
        return updateFn;
    }
 ...
 */
export var updateWithCollectionPath = function (db, collectionPath, id, data) { return __awaiter(void 0, void 0, void 0, function () {
    var debug, docRef, updatedData;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                updatedData = __assign(__assign({}, data), { updatedAt: new Date().toISOString() });
                return [4 /*yield*/, updateDoc(docRef, updatedData)];
            case 1:
                _a.sent();
